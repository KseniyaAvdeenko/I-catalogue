...
interface IMainPageBorderWidthProps extends IAdminComponentsProps {
    type: string;
    name: string;
    id: string;
    value: string | number;
...
const MainPageBorderWidth: React.FC<IMainPageBorderWidthProps> = ({
                                                                      onChangeHandler,
                                                                      type,
                                                                      id,
                                                                      value,
...
export default MainPageBorderWidth;
